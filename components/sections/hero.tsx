      ...
      <div className="container-padding mx-auto max-w-7xl pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border/40 bg-card/40 backdrop-blur-xl mb-8 text-sm shadow-sm hover:border-primary/30 transition-colors">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tighter max-w-5xl text-foreground leading-[1.1]"
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.span
                ...
                animate="animate"
              >
                <Code2 className="h-6 w-6 md:h-8 md:w-8 text-primary opacity-80" />
              </motion.span>
            </span>
            <br />
          ...
          <motion.p
            variants={itemVariants}
            className="mt-8 md:mt-10 text-xl md:text-2xl mb-4 text-muted-foreground font-light max-w-3xl text-balance leading-relaxed"
          >
          ...
          >
            <div className="relative group p-[1px] rounded-full overflow-hidden">
              ...
              <Button asChild size="xl" className="relative h-16 px-10 rounded-full bg-background/95 hover:bg-background text-foreground backdrop-blur-xl border-none shadow-2xl transition-all flex items-center gap-4 text-lg">
                <Link href={`/${locale}/contact`}>
                  {dictionary.hero.ctaPrimary}
                  <div className="w-8 h-8 rounded-full bg-foreground/10 flex items-center justify-center transition-transform duration-300 group-hover:translate-x-1 group-hover:bg-primary group-hover:text-primary-foreground">
